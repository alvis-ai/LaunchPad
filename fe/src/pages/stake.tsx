            ...
            <Col>
              <span style={{ fontSize: '16px', verticalAlign: 'middle' }}>
                ...
                <span
                  ...
                  onClick={() => {
                  }}>{isDesktopOrLaptop ? 'LaunchPad Staking Tutorial' : 'Tutorial'} </span>
              </span>
            </Col>
          </Row>
        </h2>
        <div className={styles['info']}>
          There is NO extra fee for {tokenInfo.symbol} token staking, NO extra fee for unlocking. Members in LaunchPad are attracted by our promising projects, not restricted by us charging a fee. However, IDO projects might require their own different lock-up period, see more details from the
          ...
          <Row>
            <Col span={isDesktopOrLaptop ? 16 : 24}>
              ...
              <br />
              Step2: Use {tokenInfo.symbol} token to register for IDOs on LaunchPad website, first come first serve.
              <br />
