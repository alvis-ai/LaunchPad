...
function Header(){
  return <Head>
    ...
    <meta name="description" content="LaunchPad is the first exclusive launchpad for decentralized fundraising in Boba ecosystem, offering the hottest and innovative projects in a fair, secure, and efficient way." />
    <style>
      {`
        :root {
          --header-height: 110px;
