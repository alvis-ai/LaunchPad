...
const calTokenPriceInUsd = function(tokenPriceInPT, paymentTokenDecimals = 18) {
  return tokenPriceInPT ? Number(tokenPriceInPT)/Math.pow(10, paymentTokenDecimals) : 0;
}
         ...
         return (
          ...
          >
            ...
            <Col span={isDesktopOrLaptop ? 4 : 12} className={styles["col2"]}>
              ...
              ${calTokenPriceInUsd(poolInfo.tokenPriceInPT, poolInfo.paymentTokenDecimals).toFixed(4) || '0'}
            </Col>
